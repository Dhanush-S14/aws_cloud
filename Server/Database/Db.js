...
export const ConnectDB = async ({
  ...
  // Allow selecting database via env without baking it into the URI
  ...
  const dbLabel = connectOptions.dbName ? ` (db: ${connectOptions.dbName})` : "";
  console.log(`🔌 Attempting to connect to MongoDB${dbLabel}...`);
      }
